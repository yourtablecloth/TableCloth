...
namespace TableCloth.Theme.Styling;
...
public struct Color2 : IEquatable<Color2>
{
    ...
    public static Color2 FromRGBf(float r, float g, float b, float a = 1)
    {
        Color2 newColor = new Color2();
        newColor._cType = ColorType.RGB;
        newColor._c1 = Clamp(r, 0, 1);
        newColor._c2 = Clamp(g, 0, 1);
        newColor._c3 = Clamp(b, 0, 1);
        newColor._alpha = Clamp(a, 0, 1);
        return newColor;
    }
    ...
    public static Color2 FromHSVf(float hue, float sat, float val, float alpha = 1)
    {
        Color2 newColor = new Color2();
        newColor._cType = ColorType.HSV;
        newColor._c1 = hue == -1 ? 0 : Clamp(hue % 360, 0, 360);
        newColor._c2 = Clamp(sat, 0, 1);
        newColor._c3 = Clamp(val, 0, 1);
        newColor._alpha = Clamp(alpha, 0, 1);
        return newColor;
    }
    ...
    public static Color2 FromCMYKf(float c, float m, float y, float k, float alpha = 1)
    {
        Color2 newColor = new Color2();
        newColor._cType = ColorType.CMYK;
        newColor._c1 = Clamp(c, 0, 1);
        newColor._c2 = Clamp(m, 0, 1);
        newColor._c3 = Clamp(y, 0, 1);
        newColor._c4 = Clamp(k, 0, 1);
        newColor._alpha = Clamp(alpha, 0, 1);
        return newColor;
    }
...
{
    private static Dictionary<Color2, string> ColorTable = null!;
