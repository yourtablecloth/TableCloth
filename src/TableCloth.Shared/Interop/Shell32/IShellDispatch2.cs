...
namespace TableCloth.Interop.Shell32
{
    ...
    public interface IShellDispatch2 : IShellDispatch
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        [DispId(1610809346)]
        void FindPrinter([Optional][In][MarshalAs(UnmanagedType.BStr)] string Name, [Optional][In][MarshalAs(UnmanagedType.BStr)] string location, [Optional][In][MarshalAs(UnmanagedType.BStr)] string model);
